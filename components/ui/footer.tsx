    ...
    <footer>
      <div className="py-6 md:py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols gap-8 lg:gap-20 mb-8 md:mb-12">

            {/* 1st block */}


            {/* 2nd, 3rd and 4th blocks */}
            <div className="md:col-span-2 lg:col-span-3 grid sm:grid-cols-4 gap-4">

              {/* 2nd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Certifications</h6>
                <ul>
                  <li className="mb-1">
                    <Link href="https://www.credly.com/users/emery-dittmer/badges" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Credily</Link>
                  </li>
                </ul>
              </div>

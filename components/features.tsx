      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4"> What does Emery bring to the table? </h2>
            <p className="text-xl text-gray-400">Accelerating data to insights is easy with the right mindset and skills. Emery Brings these skills and mindsets to every role</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Data Visualizations</h4>
              <p className="text-lg text-gray-400 text-center">
...
{/*                 <a href="/Visualizations" className="text-purple underline">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">
                ...
                &nbsp;
                <em><strong className="white-text">
                Emery brings over 3 years of successful p[roject management including a CAPM Certification] implementation.
